...
export const pagesContent = {
  home: {
    metadata: {
      title: 'Aheadzen | Listings, services, and local opportunities',
      description: 'Discover useful listings, trusted services, and local opportunities on Aheadzen.',
      openGraphTitle: 'Find what moves you ahead',
      openGraphDescription: 'Explore products, services, opportunities, and rentals.',
      keywords: ['classified listings', 'local services', 'opportunities', 'rentals'],
    },
    hero: {
      badge: 'Local opportunity, sharper focus',
      title: ['Find what moves you', 'ahead.'],
      description: 'Discover products, services, work, rentals, and opportunities worth knowing.',
      primaryCta: { label: 'Browse listings', href: '/classified' },
      secondaryCta: { label: 'Browse services', href: '/classified' },
      searchPlaceholder: 'Search listings, services, and opportunities',
      focusLabel: 'Focus',
