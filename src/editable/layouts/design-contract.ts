...
export const editableRootStyle = {
  ...
  '--slot4-page-text': '#f5f7f8',
  '--slot4-panel-bg': '#10151a',
  '--slot4-surface-bg': '#0b0e11',
  '--slot4-muted-text': '#a8b0b8',
  '--slot4-soft-muted-text': '#737d87',
  '--slot4-accent': '#9b6cff',
  '--slot4-accent-fill': '#8a4fff',
  '--slot4-accent-soft': '#211738',
  '--slot4-on-accent': '#ffffff',
  '--slot4-dark-bg': '#000000',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#151a20',
  '--slot4-cream': '#090b0e',
  '--slot4-warm': '#0d1116',
  '--slot4-lavender': '#100b19',
  '--slot4-gray': '#10151a',
  '--slot4-body-gradient': 'radial-gradient(circle at 72% 8%, rgba(126,67,255,.14), transparent 24%), linear-gradient(#050505,#050505)',
  '--editable-page-bg': '#050505',
  '--editable-page-text': '#f5f7f8',
  '--editable-container': '1380px',
  '--editable-border': '#232a31',
  '--editable-nav-bg': '#050505',
  '--editable-nav-text': '#f5f7f8',
  '--editable-nav-active': '#9b6cff',
  '--editable-nav-active-text': '#ffffff',
  '--editable-cta-bg': '#eef2f4',
  '--editable-cta-text': '#060708',
  '--editable-search-bg': '#10151a',
  '--editable-footer-bg': '#1a2026',
  '--editable-footer-text': '#f5f7f8',
} as CSSProperties
